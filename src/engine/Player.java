...
public class Player {
	...
	public Player(String name) {
		...
		a.setDistancetoTarget(10);
		a.setTarget("Sparta");
		a.getUnits().add(new Archer(1,60,1,1,1));
		a.getUnits().add(new Archer(2,90,1,1,1));
		a.getUnits().add(new Archer(3,80,1,1,1));
		a.getUnits().add(new Archer(4,70,1,1,1));
		Army b=new Army("Cairo");
		b.setCurrentStatus(Status.IDLE);
		b.getUnits().add(new Archer(1,60,1,1,1));
		b.getUnits().add(new Archer(2,90,1,1,1));
		b.getUnits().add(new Archer(3,80,1,1,1));
		b.getUnits().add(new Archer(4,70,1,1,1));
		Army c=new Army("Rome");
		c.setCurrentStatus(Status.BESIEGING);
		c.getUnits().add(new Archer(1,60,1,1,1));
		c.getUnits().add(new Archer(2,90,1,1,1));
		c.getUnits().add(new Archer(3,80,1,1,1));
		c.getUnits().add(new Archer(4,70,1,1,1));
		
		this.controlledArmies.add(a);
		this.controlledArmies.add(b);
		this.controlledArmies.add(c);*/
		
	}
	

	public Building getC() {
		return c;
	}


	public void setC(Building c) {
		this.c = c;
	}
